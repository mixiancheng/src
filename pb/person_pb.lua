...
local PERSON_ADDRESS_FIELD = protobuf.FieldDescriptor();
...
local ADDRESS = protobuf.Descriptor();
local ADDRESS_NAME_FIELD = protobuf.FieldDescriptor();
local ADDRESS_BOOK_FIELD = protobuf.FieldDescriptor();
...
PERSON_ADDRESS_FIELD.name = "address"
PERSON_ADDRESS_FIELD.full_name = ".Person.address"
PERSON_ADDRESS_FIELD.number = 4
PERSON_ADDRESS_FIELD.index = 3
PERSON_ADDRESS_FIELD.label = 1
PERSON_ADDRESS_FIELD.has_default_value = false
PERSON_ADDRESS_FIELD.default_value = nil
PERSON_ADDRESS_FIELD.message_type = DDRESS
PERSON_ADDRESS_FIELD.type = 11
PERSON_ADDRESS_FIELD.cpp_type = 10

PERSON.name = "Person"
PERSON.full_name = ".Person"
PERSON.nested_types = {}
PERSON.enum_types = {}
PERSON.fields = {PERSON_ID_FIELD, PERSON_NAME_FIELD, PERSON_EMAIL_FIELD, PERSON_ADDRESS_FIELD}
...
ADDRESS_NAME_FIELD.name = "name"
ADDRESS_NAME_FIELD.full_name = ".Address.name"
ADDRESS_NAME_FIELD.number = 1
ADDRESS_NAME_FIELD.index = 0
ADDRESS_NAME_FIELD.label = 1
ADDRESS_NAME_FIELD.has_default_value = false
ADDRESS_NAME_FIELD.default_value = ""
ADDRESS_NAME_FIELD.type = 9
ADDRESS_NAME_FIELD.cpp_type = 9

ADDRESS_BOOK_FIELD.name = "book"
ADDRESS_BOOK_FIELD.full_name = ".Address.book"
ADDRESS_BOOK_FIELD.number = 2
ADDRESS_BOOK_FIELD.index = 1
ADDRESS_BOOK_FIELD.label = 1
ADDRESS_BOOK_FIELD.has_default_value = false
ADDRESS_BOOK_FIELD.default_value = nil
ADDRESS_BOOK_FIELD.message_type = OOK
ADDRESS_BOOK_FIELD.type = 11
ADDRESS_BOOK_FIELD.cpp_type = 10

ADDRESS.name = "Address"
ADDRESS.full_name = ".Address"
ADDRESS.nested_types = {}
ADDRESS.enum_types = {}
ADDRESS.fields = {ADDRESS_NAME_FIELD, ADDRESS_BOOK_FIELD}
